...
export const ui = {
  bn: {
    ...
    'main.shonamoni.desc': 'একটি নেক্সট-জেনারেশন চাইল্ডকেয়ার ট্র্যাকিং অ্যাপ, বর্তমানে ডেভেলপমেন্টে আছে',
    ...
    'shonamoni.coming_soon.visit': 'একুশ ল্যাব্‌স ভিজিট করুন',
  ...
  en: {
    ...
    'main.shonamoni.desc': 'A next-generation childcare tracking app, currently in development.',
    ...
    'tools.apps.jhuri.desc': 'Simple, fast grocery list app for Android',
