...
export const ui = {
  ...
  bn: {
    ...
    'tools.tools.emi.title': 'ইএমআই ক্যালকুলেটর',
    'tools.tools.emi.desc': 'সহজেই আপনার লোন ইএমআই, মোট পেমেন্ট এবং সুদের পরিমাণ হিসাব করুন',
    'tools.tools.percent.title': 'শতাংশ ক্যালকুলেটর',
    'tools.tools.percent.desc': 'বিভিন্ন উপায়ে শতাংশ হিসাব করুন খুব সহজেই',
    ...
    'tools.emi.rate': 'বার্ষিক সুদের হার (%)',
    'tools.emi.tenure': 'লোনের মেয়াদ (মাস)',
    'tools.emi.monthly': 'মাসিক ইএমআই',
    'tools.emi.totalPayment': 'মোট পেমেন্ট',
    'tools.emi.totalInterest': 'মোট সুদ',
    'tools.emi.showTable': 'অ্যামর্টাইজেশন টেবিল দেখুন',
    'tools.emi.hideTable': 'অ্যামর্টাইজেশন টেবিল লুকান',
    'tools.emi.table.month': 'মাস',
    'tools.emi.table.opening': 'প্রারম্ভিক ব্যালেন্স',
    'tools.emi.table.emi': 'ইএমআই',
    'tools.emi.table.principal': 'আসল',
    'tools.emi.table.interest': 'সুদ',
    'tools.emi.table.closing': 'চূড়ান্ত ব্যালেন্স',

    // Tool components - Percentage Calculator
    'tools.percent.cardTitle': 'শতাংশ ক্যালকুলেটর',
    'tools.percent.mode1_title': 'Y এর X% কত?',
    'tools.percent.mode1_x': 'শতাংশ (X%)',
    'tools.percent.mode1_y': 'সংখ্যা (Y)',
    'tools.percent.mode1_result': '{0} এর {1}% হলো {2}',
    'tools.percent.mode2_title': 'Y এর কত শতাংশ হলো X?',
    'tools.percent.mode2_x': 'সংখ্যা (X)',
    'tools.percent.mode2_y': 'সংখ্যা (Y)',
    'tools.percent.mode2_result': '{1} এর {0} হলো {2}%',
    'tools.percent.mode3_title': 'X থেকে Y এ পরিবর্তনের হার',
    'tools.percent.mode3_x': 'শুরু (X)',
    'tools.percent.mode3_y': 'শেষ (Y)',
    'tools.percent.mode3_increase': 'বৃদ্ধি',
    'tools.percent.mode3_decrease': 'হ্রাস',
    'tools.percent.mode3_result': '{0} থেকে {1} হলো {2}% {3}',
    'tools.percent.mode4_title': 'Y এর সাথে X% যোগ করুন',
    'tools.percent.mode4_x': 'শতাংশ (X%)',
    'tools.percent.mode4_y': 'সংখ্যা (Y)',
    'tools.percent.mode4_result': '{1} এর সাথে {0}% যোগ করলে হয় {2}',
    'tools.percent.mode5_title': 'Y থেকে X% বিয়োগ করুন',
    'tools.percent.mode5_x': 'শতাংশ (X%)',
    'tools.percent.mode5_y': 'সংখ্যা (Y)',
    'tools.percent.mode5_result': '{1} থেকে {0}% বিয়োগ করলে হয় {2}',
    ...
    'tools.salary.location': 'কর্মস্থল / বাসাভাড়ার এলাকা',
    'tools.salary.locDhaka': 'ঢাকা সিটি কর্পোরেশন',
    'tools.salary.locCityCorp': 'অন্যান্য সিটি কর্পোরেশন',
    'tools.salary.locOther': 'জেলা/উপজেলা বা অন্যান্য',
    'tools.salary.children': 'সন্তান সংখ্যা (শিক্ষা ভাতার জন্য)',
    'tools.salary.calcButton': 'হিসাব করুন',
    'tools.salary.currentTitle': 'বর্তমান বেতন (৮ম পে-স্কেল)',
    'tools.salary.newTitle': 'প্রস্তাবিত বেতন (৯ম পে-স্কেল)',
    'tools.salary.basic': 'বেসিক',
    'tools.salary.houseRent': 'বাসা ভাড়া',
    'tools.salary.medical': 'চিকিৎসা ভাতা',
    'tools.salary.tiffin': 'টিফিন ভাতা',
    'tools.salary.childEdu': 'শিক্ষা ভাতা',
    'tools.salary.totalGross': 'মোট প্রাপ্তি (Gross)',
    'tools.salary.increase': 'বেতন বৃদ্ধি',
    'tools.salary.loading': 'লোড হচ্ছে...',
    'tools.salary.error': 'তথ্য লোড করতে সমস্যা হয়েছে।',
    'tools.salary.retry': 'আবার চেষ্টা করুন',
  },
  ...
  en: {
    ...
    'tools.tools.emi.title': 'EMI Calculator',
    'tools.tools.emi.desc': 'Calculate your loan EMI, total payment, and interest amount easily',
    'tools.tools.percent.title': 'Percentage Calculator',
    'tools.tools.percent.desc': 'Calculate percentages in various formats quickly',
    ...
    'tools.emi.rate': 'Annual Interest Rate (%)',
    'tools.emi.tenure': 'Loan Tenure (Months)',
    'tools.emi.monthly': 'Monthly EMI',
    'tools.emi.totalPayment': 'Total Payment',
    'tools.emi.totalInterest': 'Total Interest',
    'tools.emi.showTable': 'Show Amortization Table',
    'tools.emi.hideTable': 'Hide Amortization Table',
    'tools.emi.table.month': 'Month',
    'tools.emi.table.opening': 'Opening Balance',
    'tools.emi.table.emi': 'EMI',
    'tools.emi.table.principal': 'Principal',
    'tools.emi.table.interest': 'Interest',
    'tools.emi.table.closing': 'Closing Balance',

    // Tool components - Percentage Calculator
    'tools.percent.cardTitle': 'Percentage Calculator',
    'tools.percent.mode1_title': 'What is X% of Y?',
    'tools.percent.mode1_x': 'Percentage (X%)',
    'tools.percent.mode1_y': 'Number (Y)',
    'tools.percent.mode1_result': '{1}% of {0} is {2}',
    'tools.percent.mode2_title': 'X is what % of Y?',
    'tools.percent.mode2_x': 'Number (X)',
    'tools.percent.mode2_y': 'Number (Y)',
    'tools.percent.mode2_result': '{0} is {2}% of {1}',
    'tools.percent.mode3_title': '% change from X to Y',
    'tools.percent.mode3_x': 'From (X)',
    'tools.percent.mode3_y': 'To (Y)',
    'tools.percent.mode3_increase': 'Increase',
    'tools.percent.mode3_decrease': 'Decrease',
    'tools.percent.mode3_result': 'Change from {0} to {1} is {2}% {3}',
    'tools.percent.mode4_title': 'Add X% to Y',
    'tools.percent.mode4_x': 'Percentage (X%)',
    'tools.percent.mode4_y': 'Number (Y)',
    'tools.percent.mode4_result': '{1} + {0}% is {2}',
    'tools.percent.mode5_title': 'Subtract X% from Y',
    'tools.percent.mode5_x': 'Percentage (X%)',
    'tools.percent.mode5_y': 'Number (Y)',
    'tools.percent.mode5_result': '{1} - {0}% is {2}',
    ...
    'tools.salary.location': 'Workplace / House Rent Area',
    'tools.salary.locDhaka': 'Dhaka City Corporation',
    'tools.salary.locCityCorp': 'Other City Corporation',
    'tools.salary.locOther': 'District/Upazila or Other',
    'tools.salary.children': 'Number of Children (for Edu Allowance)',
    'tools.salary.calcButton': 'Calculate',
    'tools.salary.currentTitle': 'Current Salary (8th Scale)',
    'tools.salary.newTitle': 'Proposed Salary (9th Scale)',
    'tools.salary.basic': 'Basic',
    'tools.salary.houseRent': 'House Rent',
    'tools.salary.medical': 'Medical Allowance',
    'tools.salary.tiffin': 'Tiffin Allowance',
    'tools.salary.childEdu': 'Education Allowance',
    'tools.salary.totalGross': 'Total Gross',
    'tools.salary.increase': 'Increase',
    'tools.salary.loading': 'Loading...',
    'tools.salary.error': 'Failed to load data.',
    'tools.salary.retry': 'Retry',
  },
} as const;